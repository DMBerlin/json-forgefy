...
// Forgefy Operators Autocomplete with examples
const forgefyOperators = [
    ...
    { op: '$round', desc: 'Round to nearest', category: 'Math',
      usage: 'Rounds to nearest integer',
      example: '{ $round: 4.6 } → 5' },
    ...
    { op: '$trim', desc: 'Trim whitespace', category: 'String',
      usage: 'Removes leading/trailing spaces',
      example: '{ $trim: "  hello  " } → "hello"' },
    { op: '$replace', desc: 'Replace text', category: 'String',
      usage: 'Replaces text in string',
      example: '{ $replace: { input: "hello", find: "l", replace: "L" } } → "heLLo"' },
    ...
    { op: '$isNull', desc: 'Check if null', category: 'Validation',
      usage: 'Checks if value is null',
      example: '{ $isNull: null } → true' },
    { op: '$isNumber', desc: 'Check if number', category: 'Validation',
      usage: 'Checks if value is a number',
    ...
    { op: '$regex', desc: 'Regular expression match', category: 'String',
      usage: 'Tests string against regex',
      example: '{ $regex: { value: "test@email.com", pattern: "^[^@]+@[^@]+$" } } → true' },
    { op: '$regexReplace', desc: 'Regex replace', category: 'String',
      usage: 'Replaces text using regex',
      example: '{ $regexReplace: { input: "hello", pattern: "l", replacement: "L" } }' },
